...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post trees_url, params: { tree: { latitude: @tree.latitude, longitude: @tree.longitude } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { latitude: @tree.latitude, longitude: @tree.longitude } }
