...
class LightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create light" do
    assert_difference('Light.count') do
      post lights_url, params: { light: { latitude: @light.latitude, longitude: @light.longitude, pole: @light.pole, power: @light.power, type: @light.type } }
    end
  ...
  test "should update light" do
    patch light_url(@light), params: { light: { latitude: @light.latitude, longitude: @light.longitude, pole: @light.pole, power: @light.power, type: @light.type } }
